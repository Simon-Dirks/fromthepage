Fromthepage::Application.routes.draw do
  ...
  scope ':user_slug' do
    ...
    resources :collection, path: '', only: [:show] do
      ...
      get 'page_labels', as: :page_labels, to: 'collection#page_labels'
      get 'page_labels/new', as: :new_page_label, to: 'collection#new_page_label'
      post 'page_labels', as: :create_page_label, to: 'collection#create_page_label'
      get 'page_labels/:label_id/edit', as: :edit_page_label, to: 'collection#edit_page_label'
      patch 'page_labels/:label_id', as: :update_page_label, to: 'collection#update_page_label'
      delete 'page_labels/:label_id', as: :delete_page_label, to: 'collection#delete_page_label'
